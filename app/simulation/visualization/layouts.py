...
main_layout = dbc.Container(
    [
                    ...
                    dbc.Card(
                        dbc.CardBody(
                            [
                                ...
                                html.Div(
                                    id="map-container",
                                    children=map_handler.create_map(
                                        initial_users, initial_clusters
                                    ),
                                    style={
                                        "height": "650px",
                                        "borderRadius": "8px",
        ...
        # Stores
        # dcc.Store(id="user-store", data=initial_users),
        # dcc.Store(id="cluster-store", data=initial_clusters),
        dcc.Store(id="temp-coordinates", data={"origin": None, "destination": None}),
